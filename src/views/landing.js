              ...
              <Row>
                ...
                >
                  ...
                  >
                    ...
                    />
                    بچوں کو بس اللہ کا تعارف کروا دیجیے، دنیا کی مادی دوڑ سے بچا
                    کر حقیقی خوشی سے روشناس کروانے کی کوششوں میں لگے رہیے۔
                    <FaQuoteRight
                      style={{
                        fontSize: `${getMessageFontSize(width) * 3}px`,
                      }}
          ...
          <div className="row">
            <div className="col-12 offset-0 col-lg-8 offset-lg-2 text-center">
              ...
              <h3 style={{ color: 'white' }}>
                فوٹان سینڑل سکول کا مقصد بچوں کی مثبت و متوازن اسلامی اقدار کے
                مطابق تعلیم و تربیت کرنا ہے تا کہ ہمارے بچے صحیح معنوں میں اقبال
                کے شاہین اور مرد مومن بن کر معاشرے کے لیے روشنی ثابت ہوں۔ ہر جگہ
                جن کے چمکنے سے اجالا ہو جائے۔ اس مقصد کو پورا کرنے کیلئے اسلامی
                اور دینی طرز پر نصاب متعین کیا گیا ہے۔ دور حاضر کی جدت میں
                ڈھالنے کے لیے کمپیوٹر کا نصاب ہر بچے کے لئے متعین کیا گیا ہے۔ ہر
                بچے کی نفسیات کو سمجھنے کے لیے اساتذہ کے لیے خصوصی تربیت کا
                اہتمام کیا جاتا ہے۔ بچوں کو وقتاً فوقتاًاخلاقیات پر لیکچر دیا
                جاتا ہے تاکہ بچوں میں مثبت قدروں کی شجر کاری ہوتی رہے اور وہ آنے
                والے وقت میں ایک درخت بن کر اسے صراط مستقیم پر رہنے میں معاون
                ثابت ہو۔
              </h3>
            </div>
          </div>
